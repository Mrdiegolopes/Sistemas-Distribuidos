...
def iniciar_descoberta_multicast():
    ...
    try:
        ...
        multicast.enviar_multicast(mensagem_serializada, grupo=GRUPO_MULTICAST, porta=PORTA_UDP_MULTICAST)
            ...
            if requisicao.request_type == cliente_gateway_pb2.ClienteRequisicao.LISTAR_DISPOSITIVOS:
                ...
                with dispositivos_lock:
                    for dev_id, info in dispositivos_conectados.items():
                        device_proto = resposta.devices.add() 
                ...
                with dispositivos_lock:
                    if id_dispositivo in dispositivos_conectados:
                        ...
                        try:
                            ...
                            if tipo_comando_cliente == cliente_gateway_pb2.Comando.ALTERNA_ENERGIA:
                ...
                resposta.response_type = cliente_gateway_pb2.RespostaGateway.ERRO
                resposta.sucesso = False
